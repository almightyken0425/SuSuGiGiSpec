...
本文件定義 SuSuGiGi 的四大核心產品個體。每個產品皆為可獨立運作、獨立收費或進行不同層次收費的單元。
...
#### 高密度資料管理, Data Management
- **桌面版表格視圖, Data Grid:** 作為進階使用者，我想要在電腦大螢幕上以 Excel 般的表格介面瀏覽所有帳務。
- **批量操作, Batch Operations:** 作為進階使用者，我想要批量選取多筆交易進行刪除或類別變更。
...
- **報表匯出, Report Export:** 作為進階使用者，我想要將分析圖表匯出為 PDF 或圖片。
